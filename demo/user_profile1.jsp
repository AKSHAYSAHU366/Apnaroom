...
%>
   ...
   %>
   <p>  <em> Profile Photo:</em>  <img src="<%="images/"+photo00 %>" WIDTH="300" HEIGHT="300" ALIGN="BOTTOM" BORDER="0">  </p> <br><br>
   
 <%
  }
  %>
  <div> 
  <form action="add_rooms.html" method="post">
...
<%-- STARTS USER ROOM DETAILS --%>
 <%-- <%
  ...
  conn1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/apnaroom","root","");
	...
	rs1 = stmt1.executeQuery("select * from add_room where room_id="+room_id");
  %> --%>
