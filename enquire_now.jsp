...
%>
 ...
 <input type="hidden" id="ownwer_id" name="owner_id" value="<%=userId%>">
  <input type="hidden" id="customer_id" name="customer_id" value="<%=(String)session.getAttribute("user_id")%>">
 ...
 conn1.close();
 %>
 <form action="whistlist.jsp">
 <input type="hidden" id="user_id" name="user_id" value="<%=(String)session.getAttribute("user_id")%>">
  <input type="hidden" id="roomId" name="roomId" value="<%=roomId%>">
  <button type="Submit" value="whistlist">whistlist </button> 
